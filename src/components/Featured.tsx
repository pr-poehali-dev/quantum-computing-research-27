const advantages = [
  { icon: "🏭", title: "Собственное производство", desc: "Всё изготавливается на нашем заводе — никаких посредников и переплат" },
  { icon: "🛡️", title: "Гарантия качества", desc: "Даём письменную гарантию на все изделия и выполненные работы" },
  { icon: "💎", title: "Гранит и мрамор", desc: "Работаем только с натуральным камнем — от стандартных до эксклюзивных решений" },
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center min-h-screen px-6 py-12 lg:py-0 bg-white">
      <div className="flex-1 h-[400px] lg:h-[800px] mb-8 lg:mb-0 lg:order-2">
        <img
          src="https://cdn.poehali.dev/projects/ffa8a35f-effd-45bc-9e56-99d36f3c4d4a/bucket/f1a114ed-05f4-412c-915f-16a8427f47c8.jpg"
          alt="Работы ВедаГор из натурального камня"
